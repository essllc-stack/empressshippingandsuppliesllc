...
const SHOPIFY_STORE_PERMANENT_DOMAIN = '6fiqqv-q5.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'e56ce0ef498a17cc51a0626cd8061beb';
  ...
  if (response.status === 402) {
    toast.error("Shopify: Payment required", {
      description: (
        <>
          <span>
            Shopify API access requires an active billing plan. Visit{" "}
            <a href="https://admin.shopify.com" target="_blank" rel="noopener noreferrer" className="underline">
              admin.shopify.com
            </a>{" "}
            to upgrade.
          </span>
